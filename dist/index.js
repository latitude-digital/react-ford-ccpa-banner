...
// Module
exports.push([module.id, ".ford-footer-ford{padding-top:25px;padding-bottom:50px;width:100%;background-color:#f0f0f0}.ford-footer-lincoln{padding-top:25px;padding-bottom:50px;width:100%;background-color:#2b3338;border-top:1px solid #f0f0f0}.footer-container{max-width:1440px;margin-left:auto;margin-right:auto}.ford-footer-ford .nav-container{border-top:1px solid #5e5e5e;padding:56px}@media(max-width: 768px){.ford-footer-ford .nav-container{padding:0;padding-top:2em;padding-bottom:1em}}.ford-footer-lincoln .nav-container{padding-top:25px;padding-bottom:50px}.nav-padding{position:relative;display:block;padding-left:35px;padding-right:35px}@media(max-width: 768px){.nav-padding{display:flex;flex-direction:column}}.footer-img-ford{position:absolute;display:block;float:none;right:42px;margin-left:0;top:0}@media(max-width: 768px){.footer-img-ford{position:relative;padding-top:2em;left:0;margin-left:42px}}.footer-img-lincoln{height:60px;top:0;display:block;position:relative;right:0;padding-right:20px;margin-left:0;float:left}@media(max-width: 768px){.top{display:none}}.bottom-nav{position:relative;left:0;margin-top:1em;margin-left:42px}@media(min-width: 768px){.bottom-nav{display:none}}.navbar-nav{display:block;float:left;list-style-image:none;list-style-position:outside;list-style-type:none;width:auto}.ford-footer-ford .navbar-nav{margin-left:42px}.ford-footer-lincoln .navbar-nav{width:auto;max-width:90%;padding-top:10px;padding-bottom:10px;margin-right:42px;margin:0;padding:0;float:left;overflow:hidden;margin-block-start:1em;margin-block-end:1em;padding-inline-start:40px}@media(max-width: 768px){.ford-footer-lincoln .navbar-nav{float:none}}.navbar-nav li{display:block;float:left;position:relative;overflow:hidden;width:auto;font-weight:200;font-size:25.6px;font-size:1.6rem;list-style-image:none;list-style-position:outside;list-style-type:none;white-space:nowrap}@media(max-width: 768px){.navbar-nav li{float:none}}.ford-footer-ford .navbar-nav li{margin-right:20px}.ford-footer-ford .lincoln-footer-pipe{display:none}.ford-footer-lincoln .lincoln-footer-pipe{color:#fff;display:block;float:left;padding-right:10px;font-size:11px;line-height:20px}@media(max-width: 768px){.ford-footer-lincoln .lincoln-footer-pipe{display:none}}.ford-footer-ford .navbar-nav a{color:#5e5e5e}.ford-footer-lincoln .navbar-nav a{display:block;margin-right:10px;padding-right:10px;color:#fff}.ford-footer-ford .navbar-nav a:visited{color:#5e5e5e}.ford-footer-lincoln .navbar-nav a .text{color:#fff}.ford-footer-lincoln .navbar-nav a:hover .text{border-bottom:1px solid #f26147}.ford-footer-lincoln .navbar-nav a:visited .text{color:#fff}.ccpa-icon{height:1em;vertical-align:middle;margin-left:10px}", ""]);
// Exports
...
var _localizedStrings = __webpack_require__(216);
...
exports.A = _localizedStrings2.default;
...
if (typeof Symbol === 'function' && Symbol.for) {
  ...
  exports.F = symbolFor('react.fragment');
...
function isValidElementType(type) {
  ...
  if (type === exports.F || type === REACT_PROFILER_TYPE || type === REACT_DEBUG_TRACING_MODE_TYPE || type === REACT_STRICT_MODE_TYPE || type === REACT_SUSPENSE_TYPE || type === REACT_SUSPENSE_LIST_TYPE || type === REACT_LEGACY_HIDDEN_TYPE || enableScopeAPI ) {
    return true;
  }
...
var checkPropTypes = __webpack_require__(847);
...
/* harmony default export */ const get_localized_string = (getLocalizedString);
...
const FordFooter = props => {
    ...
    const privacyText = get_localized_string('privacy', language);
    const privacyRightsText = get_localized_string('privacyRights', language);
    const cookieSettingsText = get_localized_string('cookieSettings', language);
    const interestBasedAdsText = get_localized_string('interestBasedAds', language);
    const openCookieSettings = () => {
        const { Optanon } = window;
        Optanon && Optanon.ToggleInfoDisplay && Optanon.ToggleInfoDisplay();
    };
    return ((0,jsx_runtime.jsx)("div", { className: `ford-footer-${team}`, children: (0,jsx_runtime.jsx)("div", { className: "footer-container", children: (0,jsx_runtime.jsx)("nav", { className: "nav-container", children: (0,jsx_runtime.jsxs)("div", { className: "nav-padding", children: [team === 'lincoln' && ((0,jsx_runtime.jsx)("img", { className: `footer-img-${team} top`, src: 'https://cdn.latitudewebservices.com/headers/images/LincolnStar_White.png', alt: 'Lincoln Logo' })), (0,jsx_runtime.jsxs)("ul", { className: "navbar-nav", children: [(0,jsx_runtime.jsx)("li", { children: (0,jsx_runtime.jsx)("a", { href: `${privacyLink}`, target: "_blank", children: (0,jsx_runtime.jsx)("span", { className: "text", children: privacyText }) }) }), oneTrustEnabled && ((0,jsx_runtime.jsx)("li", { children: (0,jsx_runtime.jsxs)("a", { onClick: openCookieSettings, children: [(0,jsx_runtime.jsx)("div", { className: "lincoln-footer-pipe", "aria-hidden": "true", children: "|" }), (0,jsx_runtime.jsx)("span", { className: "text", children: cookieSettingsText })] }) })), (0,jsx_runtime.jsx)("li", { children: (0,jsx_runtime.jsxs)("a", { href: `${CAPrivacyLink}`, target: "_blank", children: [(0,jsx_runtime.jsx)("div", { className: "lincoln-footer-pipe", "aria-hidden": "true", children: "|" }), (0,jsx_runtime.jsx)("span", { className: "text", children: privacyRightsText }), (0,jsx_runtime.jsx)("img", { src: "https://cdn.latitudewebservices.com/icons/ccpa-icon-ford.png", alt: "opt out icon", className: "ccpa-icon" })] }) }), (0,jsx_runtime.jsx)("li", { children: (0,jsx_runtime.jsxs)("a", { href: `${interestBasedAdsLink}`, target: "_blank", children: [(0,jsx_runtime.jsx)("div", { className: "lincoln-footer-pipe", "aria-hidden": "true", children: "|" }), (0,jsx_runtime.jsx)("span", { className: "text", children: interestBasedAdsText })] }) }), otherLinks.map(link => {
                                    return ((0,jsx_runtime.jsxs)("li", { children: [(0,jsx_runtime.jsx)("div", { className: "lincoln-footer-pipe", "aria-hidden": "true", children: "|" }), (0,jsx_runtime.jsx)("a", { href: link.url, target: link.target || '_self', children: (0,jsx_runtime.jsx)("span", { className: "text", children: link.text }) })] }, link.id));
                                })] }), team === 'lincoln' && ((0,jsx_runtime.jsx)("img", { className: `footer-img-${team} bottom-nav`, src: 'https://cdn.latitudewebservices.com/headers/images/LincolnStar_White.png', alt: 'Lincoln Logo' })), team === 'ford' && ((0,jsx_runtime.jsx)("img", { className: `footer-img-${team}`, src: 'https://cdn.latitudewebservices.com/headers/images/ford_script.png', alt: 'Ford Logo', width: 63 }))] }) }) }) }));
};
/* harmony default export */ const src = (FordFooter);
