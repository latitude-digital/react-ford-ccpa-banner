...
// Module
exports.push([module.i, ".container-ford{margin-top:5px;padding:30px 20px 10px;text-align:center;width:100vw;z-index:1000;font-weight:200}.header-ford{font-family:inherit;margin-bottom:5px;padding:0}@media only screen and (min-width: 376px){.header-ford{font-size:42px}}@media screen and (max-width: 375px){.header-ford{font-size:24px}}.content-ford{font-family:inherit;padding:0 0 10px 0}@media only screen and (min-width: 376px){.content-ford{font-size:16px}}@media screen and (max-width: 375px){.content-ford{font-size:14px}}.contentLink-ford{font-family:inherit;text-decoration:underline}.privacyContainer-ford{text-align:left;width:100vw;z-index:1000;padding:50px}.privacyContainerLink-ford{text-decoration:none;padding-right:30px;font-size:12px}@media screen and (max-width: 375px){.footer-img-ford{float:left;margin-top:10px}}@media only screen and (min-width: 376px){.footer-img-ford{float:right}}.container-lincoln{margin-top:5px;padding:30px 20px 10px;text-align:center;width:100vw;z-index:1000;font-weight:200}.header-lincoln{font-family:inherit;margin-bottom:5px;padding:0;text-transform:uppercase}@media only screen and (min-width: 376px){.header-lincoln{font-size:42px}}@media screen and (max-width: 375px){.header-lincoln{font-size:24px}}.content-lincoln{font-family:inherit;padding:0 0 10px 0}@media only screen and (min-width: 376px){.content-lincoln{font-size:16px}}@media screen and (max-width: 375px){.content-lincoln{font-size:14px}}.contentLink-lincoln{font-family:inherit;text-decoration:underline;text-decoration:underline}.privacyContainer-lincoln{text-align:left;width:100vw;z-index:1000;padding:50px}@media only screen and (min-width: 376px){.privacyContainer-lincoln{padding:50px}}@media screen and (max-width: 375px){.privacyContainer-lincoln{padding:20px 50px}}.privacyContainerLink-lincoln{padding-right:15px;font-size:12px;text-transform:uppercase}.linkDivider-lincoln{padding-right:15px}a:hover{text-decoration:none}\n", ""]);
// Exports
